...
type TransportConfig struct {
	...
	Protocol                       string         `yaml:"protocol" json:"protocol" koanf:"protocol"`
...
func (cfg *TransportConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.StringVar(&cfg.Protocol, prefix+".protocol", "seata", "Client protocol used to communicate with server")
...
func InitTransportConfig(transportConf *TransportConfig) {
