...
type DeleteUndoHook struct {
	basicUndoBuilder BasicUndoBuilder
}

func (u DeleteUndoHook) Type() types.SQLType {
	return types.SQLTypeDelete
}

func (u DeleteUndoHook) Before(ctx context.Context, execCtx *exec.ExecContext) {
...
func (u DeleteUndoHook) After(ctx context.Context, execCtx *exec.ExecContext) {
	r, err := u.basicUndoBuilder.buildRecordImage(ctx, execCtx)
	if err != nil {
