...
func (m *MySQLUndoExecutorHolder) GetInsertExecutor(sqlUndoLog impl.SQLUndoLog) undo.UndoExecutor {
	return NewMySQLUndoInsertExecutor()
}

// GetUpdateExecutor get the mysql Update UndoExecutor by sqlUndoLog
func (m *MySQLUndoExecutorHolder) GetUpdateExecutor(sqlUndoLog impl.SQLUndoLog) undo.UndoExecutor {
	return NewMySQLUndoUpdateExecutor()
}

// GetDeleteExecutor get the mysql Delete UndoExecutor by sqlUndoLog
func (m *MySQLUndoExecutorHolder) GetDeleteExecutor(sqlUndoLog impl.SQLUndoLog) undo.UndoExecutor {
