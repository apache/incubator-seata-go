...
// GetInsertExecutor get the PostgreSQL Insert UndoExecutor by sqlUndoLog
func (p *PostgreSQLUndoExecutorHolder) GetInsertExecutor(sqlUndoLog undo.SQLUndoLog) undo.UndoExecutor {
	return newPostgreSQLUndoInsertExecutor(sqlUndoLog)
}

// GetUpdateExecutor get the PostgreSQL Update UndoExecutor by sqlUndoLog
func (p *PostgreSQLUndoExecutorHolder) GetUpdateExecutor(sqlUndoLog undo.SQLUndoLog) undo.UndoExecutor {
	return newPostgreSQLUndoUpdateExecutor(sqlUndoLog)
}

// GetDeleteExecutor get the PostgreSQL Delete UndoExecutor by sqlUndoLog
func (p *PostgreSQLUndoExecutorHolder) GetDeleteExecutor(sqlUndoLog undo.SQLUndoLog) undo.UndoExecutor {
	return newPostgreSQLUndoDeleteExecutor(sqlUndoLog)
}