...
func (cfg *TmConf) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.IntVar(&cfg.DegradeCheckPeriod, prefix+".degrade-check-period", 2000, "The period of degrade checking.")
	f.DurationVar(&cfg.DegradeCheckAllowTimes, prefix+".degrade-check-allow-times", 10*time.Second, "The duration allowed or degrade checking.")
...
type ClientConf struct {
	Rmconf      RmConf      `yaml:"rm" json:"rm,omitempty" property:"rm" koanf:"rm"`
	Tmconf      TmConf      `yaml:"tm" json:"tm,omitempty" property:"tm" koanf:"tm"`
	Undo        Undo        `yaml:"undo" json:"undo,omitempty" property:"undo" koanf:"undo"`
	LoadBalance LoadBalance `yaml:"load-balance" json:"load-balance,omitempty" property:"load-balance" koanf:"load-balance"`
}
