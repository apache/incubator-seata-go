                          ...
                          <div className="text-xs text-orange-700 space-y-1">
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-1 mt-1">
                                  {response.analysis_result.required_skills.map((skill, index) => (
                                    <span key={index} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-orange-200 text-orange-800">
                                      {skill}
                                    </span>
                                  ))}
                                </div>
                            ...
                            {response.analysis_result.context_tags && response.analysis_result.context_tags.length > 0 && (
                              <div className="mt-2">
                                ...
                                <span className="text-orange-600">{response.analysis_result.context_tags.join(', ')}</span>
                              </div>
                            )}
                            {response.analysis_result.suggested_workflow && (
                              <div className="mt-2">
                                <span className="font-medium">建议工作流: </span>
                                <span className="text-orange-600">{response.analysis_result.suggested_workflow}</span>
                              </div>
                            )}
                          </div>
                        </div>
