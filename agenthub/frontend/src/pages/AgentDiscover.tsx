...
import {AlertCircle, Copy, ExternalLink, Search, Zap} from 'lucide-react';
                          ...
                          找到匹配
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center justify-between">
                                                    <span
                                                        className="text-xs font-medium text-success-900">Agent URL:</span>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <span
                                                        className="text-xs font-medium text-success-900">总技能数:</span>
                                                    <span
                                                        className="text-xs text-success-700">{agent.skills.length} 个</span>
                                                </div>
                                                        ...
                                                        {agent.skills
                                                            ...
                                                            .map(skill => (
                                                                <div key={skill.id}
                                                                    ...
                                                                    <div className="flex items-center justify-between">
                                                                        <span
                                                                            className="text-xs font-medium text-gray-900">{skill.name}</span>
                                                                        <span
                                                                            className="text-xs text-gray-500">({skill.id})</span>
                                                                    </div>
