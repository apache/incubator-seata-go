...
import {Activity, AlertCircle, Brain, Plus, Search, TrendingUp, Users} from 'lucide-react';
import AgentHubAPI from '../services/api';
import {RegisteredAgent} from '../types';
import {formatRelativeTime, getStatusText, isAgentOnline} from '../utils';
                    ...
                    {quickActions.map((action) => {
                        ...
                        return (
                            ...
                            >
                                <div>
                  <span
                      className={`${action.color} rounded-lg inline-flex p-3 text-white group-hover:scale-110 transition-transform duration-200`}>
